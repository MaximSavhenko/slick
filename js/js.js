!(function (e) {
     ...
     */ !(function (t, n) {
          ...
          function (e, t) {
            T.fn[e] = function (n, i) {
              ...
              return (
                ...
                this.length > 1 &&
                  (P[e] || T.uniqueSort(o), L.test(e) && o.reverse()),
                this.pushStack(o)
              );
            };
          }
      ...
      (T.Callbacks = function (e) {
        ...
        T.extend({
          ...
          when: function (e) {
            ...
            if (
              t <= 1 &&
              (I(e, r.done(s(n)).resolve, r.reject, !t),
        ...
        special: {
          ...
          click: {
            ...
            trigger: function (e) {
              var t = this || e;
              return (
                ve.test(t.type) && t.click && j(t, "input") && De(t, "click"),
                !0
              );
            },
            _default: function (e) {
      ...
      function ze(e, t, n, i) {
        ...
        if (
          ...
          for (a = (s = T.map(be(o, "script"), Pe)).length; u < p; u++)
            (c = o),
              u !== f &&
          ...
          if (a)
            for (
              d = s[s.length - 1].ownerDocument, T.map(s, _e), u = 0;
              u < a;
              u++
            )
              (c = s[u]),
        ...
        T.fn.extend({
          ...
          hasClass: function (e) {
            var t,
              ...
              i = 0;
            for (t = " " + e + " "; (n = this[i++]); )
              if (1 === n.nodeType && (" " + mt(bt(n)) + " ").indexOf(t) > -1)
                return !0;
            return !1;
          },
        });
      ...
      T.extend(T.event, {
        trigger: function (e, t, i, o) {
          ...
          if (
            ...
            if (!o && !u.noBubble && !m(i)) {
              for (
                l = u.delegateType || v, kt.test(l + v) || (s = s.parentNode);
                s;
                s = s.parentNode
              )
                h.push(s), (a = s);
          ...
          ajax: function (e, t) {
            ...
            function C(e, t, s, l) {
              ...
              c ||
                ...
                (S.status = e),
                (S.statusText = (t || k) + ""),
                u ? g.resolveWith(h, [p, k, S]) : g.rejectWith(h, [S, k, b]),
                S.statusCode(m),
                (m = void 0),
                d &&
                  v.trigger(u ? "ajaxSuccess" : "ajaxError", [S, f, u ? p : b]),
                y.fireWith(h, [S, k]),
                d &&
  ...
  function (e, t, n) {
     ...
     * https://wowjs.uk
     * Copyright (c) 2016 Thomas Grainger; Licensed MIT */ (o = [e, t]),
      void 0 ===
        (r =
          "function" ==
              ...
              (s.version = "master"),
                ...
                (s._apply = function (t, n) {
                  ...
                  return (
                    ...
                    s._maintainScroll &&
                      e(window).scrollTop((d / u) * e("html").outerHeight(!0)),
                    this
                  );
                }),
      ...
      if (
        ...
        try {
          for (let e in document.styleSheets) {
            ...
            if (t.rules)
              for (let e = t.rules.length - 1; e >= 0; e--)
                t.rules[e].selectorText &&
                  t.rules[e].selectorText.match(":hover") &&
                  t.deleteRule(e);
          }
        } catch (e) {}
      let o;
      e(document).ready(function () {
        e(".phone__slider").length &&
          e(".phone__slider").slick({
            dots: !1,
            arrows: !1,
            speed: 400,
            lazyLoad: "ondemand",
          ...
          e(document).on("click", ".app__btns-item", function (t) {
            e(this).hasClass("active") ||
              (e(".app__btns-item").removeClass("active"),
              e(this).addClass("active")),
              e(".phone__slider").slick("slickGoTo", e(this).index()),
              t.preventDefault();
          }),
          e(".app__btns-item").hover(
            function () {
              e(this).trigger("click");
            },
            function () {}
          ),
          e(".video__slider").length &&
            e(".video__slider").each(function () {
              let t = e(this);
              t.find(".video__item").length < 3 &&
                e(
                  ".slider__nav-box",
                  t.closest(".video__slider-wrap")
                ).addClass("hidden-sm-up"),
                t.slick({
                  dots: !1,
                  prevArrow: t
                    .closest(".video__slider-wrap")
                    .find(".slide__prev"),
                  nextArrow: t
                    .closest(".video__slider-wrap")
                    .find(".slide__next"),
          ...
          e(".theme__slider").length &&
            e(".theme__slider").slick({
              dots: !1,
              prevArrow: e(".theme__slider-box").find(".slide__prev"),
              nextArrow: e(".theme__slider-box").find(".slide__next"),
              speed: 600,
              lazyLoad: "ondemand",
              slidesToShow: 3,
              slidesToScroll: 1,
          ...
          e(".theme__item-descr").matchHeight(),
          e(".scroll").on("click", function (t) {
            e("html, body")
              .stop()
              .animate(
                { scrollTop: e(e(this).attr("href")).offset().top + "px" },
                850
              ),
              t.preventDefault();
          }),
          e(document).on(
            "click",
            ".video__insert-box .play__icon",
            function (t) {
              let n = e(this).attr("data-video"),
                i = e(this).closest(".video__item-img");
              if (n.includes("embed"))
                i.find(".video__frame").html(
                  '<iframe id="player" src="' +
                    n +
                    '?enablejsapi=1&autoplay=1&rel=0&showinfo=0"></iframe>'
                );
              else {
                let e = n.split("?v=");
                i.find(".video__frame").html(
              ...
              i.find(".video__box").addClass("active"),
                (o = new YT.Player("player", {
                  events: {
                    onStateChange: function (e) {
                      switch (e.data) {
                        case 0:
                          i.find(".video__box").removeClass("active"),
                            i.find(".video__frame").html("");
                      }
                    },
                  },
          ...
          e(document).on("click", ".lang__switch", function (t) {
            e(this).closest(".lang").toggleClass("active"), t.preventDefault();
          }),
          e(document).on("click", "a.video__item-img", function (t) {
            let n = e(this).attr("data-video"),
              i = e(".modal__video");
            if (
              (i.fadeIn(function () {
                i.find(".modal__video-block").addClass("active");
              }),
              n.includes("embed"))
            )
              i.find(".video__frame").html(
                ...
                events: {
                  onStateChange: function (e) {
                    switch (e.data) {
                      case 0:
                        i.fadeOut(function () {
                          i.find(".modal__video-block").removeClass("active"),
                            i.find(".video__box").removeClass("active"),
                            i.find(".video__frame").html("");
                        });
                    }
          ...
          e(document).on("click", ".modal__close", function (t) {
            let n = e(".modal__video");
            n.fadeOut(function () {
              n.find(".modal__video-block").removeClass("active"),
                n.find(".video__box").removeClass("active"),
                n.find(".video__frame").html("");
            }),
              t.preventDefault();
          });
      }),
